...
boton.addEventListener('click', (e) => {
    if ([...formularioGasto.classList].includes('formulario-gasto--active')) { //*spread operator (crear una copia superficial (una nueva matriz) de las clases del elemento)
...
const cargarGastos = () => {
  const gastos = JSON.parse(window.localStorage.getItem('gastos')); //JSON.parse lo convierte a objeto en javascript
...
const cargarTotalGastado = () => {
    ...
    if (gastos) {
        ...
        //FORMATEAR EL NUMERO Y LO AGG AL CONTENEDOR.
        const formatoMoneda = new Intl.NumberFormat('en-MX', { style: 'currency', currency: 'MXN' });
